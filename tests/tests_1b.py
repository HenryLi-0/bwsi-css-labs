...
def test_addition():
    ...
    assert simple_calculator("add", 1155, 2265) == 3420 # test 1155+2265=3420
    assert simple_calculator("add", 1, -1) == 0         # Test for positive and negative number
...
def test_subtraction():
    ...
    assert simple_calculator("subtract", -1, 2) == -3   # Test for negative and positive
    assert simple_calculator("subtract", 1, -2) == 3    # Test for positive and negative
...
def test_multiplication():
    ...
    assert simple_calculator("multiply", 694, 1) == 694 # Test for multiplication by one
...
def test_division():
    ...
    assert simple_calculator("divide", 1, 1) == 1       # Test for division by 1
    assert simple_calculator("divide", 0, 10) == 0      # Test for division operation on 0
